...
pub fn add_call_frame(
    ...
    let arguments_index_address = builder.ins().iadd(call_stack_ptr, arguments_index_offset);
...
pub fn get_call_frame(
    ...
    let instruction_pointer_address = builder
        .ins()
        .iadd(call_stack_ptr, instruction_pointer_total_offset);
    let ip = builder
        .ins()
    ...
    let function_index_address = builder
        .ins()
        .iadd(call_stack_ptr, function_index_total_offset);
    ...
    let register_range_start_address = builder
        .ins()
        .iadd(call_stack_ptr, register_range_start_total_offset);
    ...
    let register_range_end_address = builder
        .ins()
        .iadd(call_stack_ptr, register_range_end_total_offset);
    ...
    let arguments_index_address = builder
        .ins()
        .iadd(call_stack_ptr, arguments_index_total_offset);
    let arguments_index =
        builder
            .ins()
