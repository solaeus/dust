    ...
    assert_eq!(
        ...
        vec![
            ...
            SyntaxNode {
                ...
                payload: SyntaxPayload::children(0, 3),
                span: Span(0, 19),
            },
            SyntaxNode {
...
fn list_byte() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            SyntaxNode {
                kind: SyntaxKind::ByteExpression,
                payload: SyntaxPayload::children(44, 0),
                span: Span(13, 17),
            }
        ]
    );
...
fn list_character() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            SyntaxNode {
                kind: SyntaxKind::CharacterExpression,
                payload: SyntaxPayload::children(99, 0),
                span: Span(11, 14),
            }
        ]
    );
...
fn list_index_boolean() {
    ...
    assert_eq!(
        ...
        vec![
            SyntaxNode {
                kind: SyntaxKind::MainFunctionItem,
                payload: SyntaxPayload::children(8, 2),
                span: Span(0, 35),
            },
            SyntaxNode {
                kind: SyntaxKind::LetStatement,
                payload: SyntaxPayload::children(4, 3),
                span: Span(1, 29),
            },
            SyntaxNode {
            ...
            SyntaxNode {
                ...
                payload: SyntaxPayload::children(6, 0),
                span: Span(9, 29),
            },
            SyntaxNode {
                kind: SyntaxKind::BooleanExpression,
            ...
            SyntaxNode {
                ...
                payload: SyntaxPayload::children(11, 12),
                span: Span(30, 34),
            },
            SyntaxNode {
                kind: SyntaxKind::IntegerExpression,
...
fn local_list_equal() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            SyntaxNode {
                kind: SyntaxKind::LetStatement,
                payload: SyntaxPayload::children(3, 3),
                span: Span(1, 23),
            },
            SyntaxNode {
                kind: SyntaxKind::PathSegment,
            ...
            SyntaxNode {
                kind: SyntaxKind::ListExpression,
                payload: SyntaxPayload::children(1, 2),
                span: Span(9, 22),
            },
            SyntaxNode {
                kind: SyntaxKind::ExpressionStatement,
            ...
            SyntaxNode {
                kind: SyntaxKind::LetStatement,
                payload: SyntaxPayload::children(9, 3),
                span: Span(24, 46),
            },
            SyntaxNode {
                kind: SyntaxKind::PathSegment,
            ...
            SyntaxNode {
                kind: SyntaxKind::ListExpression,
                payload: SyntaxPayload::children(7, 2),
                span: Span(32, 45),
            },
            SyntaxNode {
                kind: SyntaxKind::ExpressionStatement,
            ...
            SyntaxNode {
                ...
                payload: SyntaxPayload::children(17, 20),
                span: Span(47, 53),
            },
            SyntaxNode {
                kind: SyntaxKind::PathSegment,
