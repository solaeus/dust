...
fn empty() {
    ...
    assert_eq!(
        syntax_tree.sorted_nodes(),
        [
            Root.with_child(Span::new(0, 10), SyntaxId(2)),
            ModuleItem.with_child(Span::new(0, 10), SyntaxId(1)),
            SimplePath.empty(Span::new(4, 7)),
        ]
    );
}
...
fn nested() {
    ...
    assert_eq!(
        ...
        [
            ...
            ModuleItem.with_binary_children(Span::new(0, 22), SyntaxId(1), SyntaxId(3)),
            SimplePath.empty(Span::new(4, 7)),
            ModuleItem.with_child(Span::new(10, 20), SyntaxId(2)),
