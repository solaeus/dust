...
fn empty() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 11), SyntaxPayload::child_indices(0, 3)),
...
fn value_parameters() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 26), SyntaxPayload::child_indices(4, 7)),
            SimplePath.empty(Span::new(3, 6)),
            FunctionParameters.with_child(Span::new(0, 23), SyntaxId(6)),
            ValueParameters.with_multiple_children(Span::new(0, 23), SyntaxPayload::child_indices(0, 4)),
...
fn type_parameters() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 20), SyntaxPayload::child_indices(3, 6)),
            SimplePath.empty(Span::new(3, 6)),
            FunctionParameters.with_binary_children(Span::new(0, 17), SyntaxId(6), SyntaxId(5)),
            ValueParameters.empty(Span::new(0, 17)),
            TypeParameters.with_multiple_children(Span::new(6, 15), SyntaxPayload::child_indices(0, 3)),
            SimplePath.empty(Span::new(7, 8)),
...
fn return_type() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 18), SyntaxPayload::child_indices(0, 4)),
            SimplePath.empty(Span::new(3, 6)),
            FunctionParameters.with_child(Span::new(0, 8), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 8)),
...
fn mixed() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 35), SyntaxPayload::child_indices(7, 11)),
            SimplePath.empty(Span::new(3, 6)),
            FunctionParameters.with_binary_children(Span::new(0, 27), SyntaxId(12), SyntaxId(5)),
            ValueParameters.with_multiple_children(Span::new(0, 27), SyntaxPayload::child_indices(3, 7)),
