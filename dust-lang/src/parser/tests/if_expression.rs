...
fn r#if() {
    ...
    assert_eq!(
        ...
        [
            Root.with_child(Span::new(0, 40), SyntaxId(19)),
            FunctionItem.with_binary_children(Span::new(0, 40), SyntaxId(1), SyntaxId(18)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionExpression.with_binary_children(Span::new(7, 40), SyntaxId(4), SyntaxId(17)),
            ...
            BlockExpression.with_child(Span::new(10, 40), SyntaxId(16)),
            IfExpression.with_binary_children(Span::new(16, 38), SyntaxId(7), SyntaxId(15)),
            PathExpression.with_child(Span::new(19, 28), SyntaxId(5)),
            PathSegment.empty(Span::new(19, 28)),
            BlockExpression.with_child(Span::new(29, 38), SyntaxId(14)),
            AdditionExpression.with_binary_children(Span::new(31, 36), SyntaxId(10), SyntaxId(13)),
...
fn if_else() {
    ...
    assert_eq!(
        ...
        [
            ...
            SimplePath.empty(Span::new(3, 7)),
            FunctionExpression.with_binary_children(Span::new(7, 55), SyntaxId(4), SyntaxId(25)),
            FunctionSignature.with_child(Span::new(7, 9), SyntaxId(3)),
            FunctionParameters.with_child(Span::new(7, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(7, 9)),
            ...
            PathExpression.with_child(Span::new(35, 36), SyntaxId(11)),
            PathSegment.empty(Span::new(35, 36)),
            BlockExpression.with_child(Span::new(44, 53), SyntaxId(22)),
...
fn if_else_if() {
    ...
    assert_eq!(
        syntax_tree.sorted_nodes(),
        [
            Root.with_child(Span::new(0, 74), SyntaxId(39)),
            FunctionItem.with_binary_children(Span::new(0, 74), SyntaxId(1), SyntaxId(38)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionExpression.with_binary_children(Span::new(7, 74), SyntaxId(4), SyntaxId(37)),
            FunctionSignature.with_child(Span::new(7, 9), SyntaxId(3)),
            FunctionParameters.with_child(Span::new(7, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(7, 9)),
            BlockExpression.with_child(Span::new(10, 74), SyntaxId(36)),
            ...
            BlockExpression.with_child(Span::new(24, 33), SyntaxId(14)),
            AdditionExpression.with_binary_children(Span::new(26, 31), SyntaxId(10), SyntaxId(13)),
            ...
            BlockExpression.with_child(Span::new(48, 57), SyntaxId(25)),
            SubtractionExpression.with_binary_children(
                Span::new(50, 55),
                SyntaxId(21),
                SyntaxId(24)
            ...
            BlockExpression.with_child(Span::new(63, 72), SyntaxId(33)),
