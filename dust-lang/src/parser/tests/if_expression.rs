...
fn r#if() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 40), SyntaxPayload::child_indices(0, 3)),
...
fn if_else() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 55), SyntaxPayload::child_indices(3, 6)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionParameters.with_child(Span::new(0, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 9)),
            BlockExpression.with_child(Span::new(10, 55), SyntaxId(18)),
            IfExpression.with_multiple_children(Span::new(16, 53), SyntaxPayload::child_indices(0, 3)),
            PathExpression.with_child(Span::new(19, 28), SyntaxId(4)),
            PathSegment.empty(Span::new(19, 28)),
            BlockExpression.with_child(Span::new(29, 38), SyntaxId(10)),
            AdditionExpression.with_binary_children(Span::new(31, 36), SyntaxId(7), SyntaxId(9)),
            ...
            SubtractionExpression.with_binary_children(Span::new(46, 51), SyntaxId(13), SyntaxId(15)),
...
fn if_else_if() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem.with_multiple_children(Span::new(0, 74), SyntaxPayload::child_indices(6, 9)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionParameters.with_child(Span::new(0, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 9)),
            BlockExpression.with_child(Span::new(10, 74), SyntaxId(27)),
            IfExpression.with_multiple_children(Span::new(16, 72), SyntaxPayload::child_indices(3, 6)),
            ...
            IfExpression.with_multiple_children(Span::new(39, 72), SyntaxPayload::child_indices(0, 3)),
            ...
            SubtractionExpression.with_binary_children(Span::new(50, 55), SyntaxId(15), SyntaxId(17)),
            PathExpression.with_child(Span::new(50, 51), SyntaxId(14)),
            PathSegment.empty(Span::new(50, 51)),
            ...
            MultiplicationExpression.with_binary_children(Span::new(65, 70), SyntaxId(21), SyntaxId(23)),
