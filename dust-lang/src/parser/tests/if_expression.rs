...
fn r#if() {
    ...
    assert_eq!(
        ...
        [
            ...
            BlockExpression.with_single_child(Span::new(10, 40), SyntaxId(13)),
            IfExpression.with_binary_children(Span::new(16, 38), SyntaxId(6), SyntaxId(12)),
            PathExpression.with_single_child(Span::new(19, 28), SyntaxId(5)),
            PathSegment.empty(Span::new(19, 28)),
            BlockExpression.with_single_child(Span::new(29, 38), SyntaxId(11)),
            AdditionExpression.with_binary_children(Span::new(31, 36), SyntaxId(8), SyntaxId(10)),
            PathExpression.with_single_child(Span::new(31, 32), SyntaxId(7)),
            PathSegment.empty(Span::new(31, 32)),
            PathExpression.with_single_child(Span::new(35, 36), SyntaxId(9)),
...
fn if_else() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionParameters.with_single_child(Span::new(0, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 9)),
            BlockExpression.with_single_child(Span::new(10, 55), SyntaxId(19)),
            IfExpression.with_children(Span::new(16, 53), SyntaxChildren::new(1, 4)),
            PathExpression.with_single_child(Span::new(19, 28), SyntaxId(5)),
            PathSegment.empty(Span::new(19, 28)),
            BlockExpression.with_single_child(Span::new(29, 38), SyntaxId(11)),
            AdditionExpression.with_binary_children(Span::new(31, 36), SyntaxId(8), SyntaxId(10)),
            ...
            PathExpression.with_single_child(Span::new(35, 36), SyntaxId(9)),
            PathSegment.empty(Span::new(35, 36)),
            BlockExpression.with_single_child(Span::new(44, 53), SyntaxId(17)),
            SubtractionExpression.with_binary_children(
                Span::new(46, 51),
                SyntaxId(14),
                SyntaxId(16)
            ),
            PathExpression.with_single_child(Span::new(46, 47), SyntaxId(13)),
            PathSegment.empty(Span::new(46, 47)),
            PathExpression.with_single_child(Span::new(50, 51), SyntaxId(15)),
...
fn if_else_if() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionParameters.with_single_child(Span::new(0, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 9)),
            BlockExpression.with_single_child(Span::new(10, 74), SyntaxId(28)),
            IfExpression.with_children(Span::new(16, 72), SyntaxChildren::new(4, 7)),
            PathExpression.with_single_child(Span::new(19, 23), SyntaxId(5)),
            PathSegment.empty(Span::new(19, 23)),
            BlockExpression.with_single_child(Span::new(24, 33), SyntaxId(11)),
            ...
            PathExpression.with_single_child(Span::new(30, 31), SyntaxId(9)),
            PathSegment.empty(Span::new(30, 31)),
            IfExpression.with_children(Span::new(39, 72), SyntaxChildren::new(1, 4)),
            PathExpression.with_single_child(Span::new(42, 47), SyntaxId(13)),
            PathSegment.empty(Span::new(42, 47)),
            BlockExpression.with_single_child(Span::new(48, 57), SyntaxId(19)),
            SubtractionExpression.with_binary_children(
                Span::new(50, 55),
                SyntaxId(16),
                SyntaxId(18)
            ...
            PathExpression.with_single_child(Span::new(50, 51), SyntaxId(15)),
            PathSegment.empty(Span::new(50, 51)),
            PathExpression.with_single_child(Span::new(54, 55), SyntaxId(17)),
            PathSegment.empty(Span::new(54, 55)),
            BlockExpression.with_single_child(Span::new(63, 72), SyntaxId(25)),
            MultiplicationExpression.with_binary_children(
                Span::new(65, 70),
                SyntaxId(22),
                SyntaxId(24)
            ),
            PathExpression.with_single_child(Span::new(65, 66), SyntaxId(21)),
            PathSegment.empty(Span::new(65, 66)),
            PathExpression.with_single_child(Span::new(69, 70), SyntaxId(23)),
