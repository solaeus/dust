...
fn simple() {
    ...
    assert_eq!(
        ...
        [
            ...
            BlockExpression.with_child(Span::new(10, 21), SyntaxId(6)),
...
fn with_type_arguments() {
    ...
    assert_eq!(
        ...
        [
            ...
            FunctionItem
                .with_multiple_children(Span::new(0, 28), SyntaxPayload::child_indices(1, 4)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionSignature
                .with_multiple_children(Span::new(0, 9), SyntaxPayload::child_indices(0, 1)),
            FunctionParameters.with_child(Span::new(0, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(0, 9)),
            BlockExpression.with_child(Span::new(10, 28), SyntaxId(9)),
            PathExpression.with_child(Span::new(16, 26), SyntaxId(8)),
            PathSegment.with_child(Span::new(16, 19), SyntaxId(7)),
            TypeArguments.with_child(Span::new(21, 26), SyntaxId(6)),
            TypePath.with_child(Span::new(22, 25), SyntaxId(5)),
...
fn with_multiple_type_arguments() {
    ...
    assert_eq!(
        ...
        [
            ...
            PathExpression.with_child(Span::new(16, 31), SyntaxId(10)),
            PathSegment.with_child(Span::new(16, 19), SyntaxId(9)),
            TypeArguments.with_binary_children(Span::new(21, 31), SyntaxId(6), SyntaxId(8)),
            TypePath.with_child(Span::new(22, 25), SyntaxId(5)),
            PathSegment.empty(Span::new(22, 25)),
            TypePath.with_child(Span::new(27, 30), SyntaxId(7)),
...
fn multi_segment_with_type_arguments() {
    ...
    assert_eq!(
        ...
        [
            ...
            PathSegment.empty(Span::new(16, 19)),
            PathSegment.with_child(Span::new(21, 24), SyntaxId(8)),
            TypeArguments.with_child(Span::new(26, 31), SyntaxId(7)),
