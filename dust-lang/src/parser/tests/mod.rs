...
fn reassignment_statement() {
    ...
    assert_eq!(
        ...
        [
            ...
            ReassignmentStatement.with_binary_children(Span::new(16, 23), SyntaxId(5), SyntaxId(7)),
...
fn grouped_expression() {
    ...
    assert_eq!(
        syntax_tree.sorted_nodes(),
        [
            Root.with_child(Span::new(0, 25), SyntaxId(15)),
            FunctionItem.with_binary_children(Span::new(0, 25), SyntaxId(1), SyntaxId(14)),
            SimplePath.empty(Span::new(3, 7)),
            FunctionExpression.with_binary_children(Span::new(7, 25), SyntaxId(4), SyntaxId(13)),
            FunctionSignature.with_child(Span::new(7, 9), SyntaxId(3)),
            FunctionParameters.with_child(Span::new(7, 9), SyntaxId(2)),
            ValueParameters.empty(Span::new(7, 9)),
            BlockExpression.with_child(Span::new(10, 25), SyntaxId(12)),
            GroupedExpression.with_child(Span::new(16, 23), SyntaxId(11)),
            AdditionExpression.with_binary_children(Span::new(17, 22), SyntaxId(7), SyntaxId(10)),
