    ...
    fn from(token: TokenKind) -> Self {
        match token {
            ...
            TokenKind::Bang => ParseRule {
                prefix: Some(Parser::parse_prefix_unary_operator),
                infix: None,
            ...
            TokenKind::Break => ParseRule {
                prefix: Some(Parser::parse_prefix_break_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::Fn => ParseRule {
                prefix: Some(Parser::parse_prefix_fn_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::If => ParseRule {
                prefix: Some(Parser::parse_prefix_if_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::Mod => ParseRule {
                prefix: Some(Parser::parse_prefix_mod_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::Pub => ParseRule {
                prefix: Some(Parser::parse_prefix_pub_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            TokenKind::Return => ParseRule {
                prefix: Some(Parser::parse_prefix_return_keyord),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::Struct => ParseRule {
                prefix: Some(Parser::parse_prefix_struct_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
            ...
            TokenKind::While => ParseRule {
                prefix: Some(Parser::parse_prefix_while_keyword),
                infix: None,
                precedence: Precedence::None,
                associativity: Associativity::Left,
            },
