...
fn local_byte_exponent() {
    ...
    assert_eq!(
        ...
        Prototype {
            ...
            instructions: vec![
                Instruction::r#move(0, Address::encoded_byte(2)),
                Instruction::r#move(1, Address::encoded_byte(3)),
                Instruction::power(2, Address::register(0), Address::register(1)),
...
fn local_mut_byte_exponent() {
    ...
    assert_eq!(
        ...
        Prototype {
            ...
            instructions: vec![
                Instruction::r#move(0, Address::encoded_byte(2)),
                Instruction::power(0, Address::register(0), Address::encoded_byte(3)),
...
fn local_mut_float_exponent() {
    ...
    assert_eq!(
        ...
        Prototype {
            ...
            instructions: vec![
                Instruction::r#move(0, Address::constant(0)),
                Instruction::power(0, Address::register(0), Address::constant(1)),
                Instruction::r#return(Address::register(0))
            ],
            register_count: 1,
            ..Prototype::dummy()
