        ...
        prototypes: [
            Prototype {
                instructions: vec![
                    ...
                    Instruction::r#move(4, OperandType::I_64, Address::new(Memory::ENCODED, 3)),
        ...
        prototypes: [
            Prototype {
                instructions: vec![
                    ...
                    Instruction::r#move(2, OperandType::I_64, Address::new(Memory::REGISTER, 0)),
                    Instruction::r#move(4, OperandType::I_64, Address::new(Memory::REGISTER, 0)),
                    Instruction::r#return(),
                ],
                return_types: smallvec![OperandType::I_64, OperandType::I_64, OperandType::I_64],
                register_count: 6,
        ...
        prototypes: [
            Prototype {
                instructions: vec![
                    ...
                    Instruction::r#move(4, OperandType::I_64, Address::new(Memory::ENCODED, 30)),
        ...
        prototypes: [
            Prototype {
                instructions: vec![
                    ...
                    Instruction::r#move(2, OperandType::I_64, Address::new(Memory::ENCODED, 20)),
                    Instruction::r#move(4, OperandType::I_64, Address::new(Memory::ENCODED, 30)),
                    Instruction::r#move(6, OperandType::I_32, Address::new(Memory::ENCODED, 1)),
                    Instruction::get(0, OperandType::I_64, 0, Address::new(Memory::REGISTER, 6)),
                    Instruction::r#return(),
                ],
                return_types: smallvec![OperandType::I_64],
                register_count: 7,
